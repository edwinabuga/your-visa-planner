...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-12">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(194,126,84,0.06),transparent_70%)] dark:bg-[radial-gradient(circle_at_50%_50%,rgba(194,126,84,0.08),transparent_70%)]" />
